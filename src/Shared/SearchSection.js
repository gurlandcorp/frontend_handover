              ...
              <div className="row">
                ...
                <div className="col-lg-4 pl-15 pr-0">
                  <div className="rld-single-select mt-0">
                    ...
                    <div
                      className="nice-select select single-select mr-0"
                      tabIndex="0"
                    >
                          ...
                          <div className="range-box">
                            ...
                            <div className="price-filter-wrap d-flex align-items-center">
                              <div className="price-range-select">
                                ...
                                ></div>
                                <div className="price-range range-title">sft</div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="range-box">
                            ...
                            <div className="price-filter-wrap d-flex align-items-center">
                              <div className="price-range-select">
                                ...
                                ></div>
                                <div className="price-range range-title">km</div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <ul className="no-ul-list third-row">
                        ...
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-3" className="checkbox-custom-label">
                            Heating
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-4" className="checkbox-custom-label">
                            Internet
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-5" className="checkbox-custom-label">
                            Microwave
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-6" className="checkbox-custom-label">
                            Smoking Allow
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-7" className="checkbox-custom-label">
                            Terrace
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-8" className="checkbox-custom-label">
                            Balcony
                          </label>
                        </li>
                        <li>
                          <input
                            ...
                            type="checkbox"
                          />
                          <label htmlFor="a-9" className="checkbox-custom-label">
                            Balcony
                          </label>
                        </li>
                      </ul>
