...
import About08 from "../assets/img/about/about08.jpg";
import About09 from "../assets/img/about/about09.jpg";
          ...
          <div className="row flex-row-reverse flex-lg-row">
            <div className="col-xl-6 col-lg-6">
              <div className="about-img">
                <img src={`${About08}`} alt="about" width={746} height={587} />
              </div>
            </div>
            <div className="col-xl-6 col-lg-6">
          ...
          <div className="row flex-row flex-lg-row-reverse">
            <div className="col-xl-6 col-lg-6">
              <div className="about-layout3">
                <div className="item-img">
                  <img src={About09} alt="about" width={809} height={587} />
